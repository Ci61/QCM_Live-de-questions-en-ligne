...
<head>
	...
	<link rel="icon" href="./vue/utilisateur/img/service_icon1.png" type="image/png">
	...
	<script type="text/javascript" src="./vue/utilisateur/js/jquery.1.8.3.min.js"></script>
...
<body>
					...
					<div class="row">
						<div class="col-lg-5 col-sm-7">
							<div class="top_left_cont flipInY wow animated">
								<h2> COUCOU ^^ 
								<?php printf (' %s', $login); echo ('<br/>');
									printf ('GROUP:  %d', $_SESSION['profil']['num_grpe']); echo ('<br/>');
								?></h2>
								<p> <?php 
									print_r ($_SESSION['profil']['nom']." ".$_SESSION['profil']['prenom']);echo ('<br/>');
									print_r ($_SESSION['profil']['email']);echo ('<br/>');
									?></p>
								<a href="index.php?controle=etudiant&action=page_profile" class="learn_more2">Voir votre profil</a> </div>
						</div>
					</div>
				</div>
			</div>
	...
	<?php require("./vue/etudiant/services.tpl"); ?>
